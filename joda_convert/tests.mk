...
TEST_BIN = $(BUILD_DIR)/joda_convert_tests
...
TRANSLATE_ARGS = -cp $(DIST_LIB_DIR)/j2objc_joda_convert.jar:$(DIST_LIB_DIR)/$(JUNIT_JAR) -q
include ../make/translate.mk

test: $(TEST_BIN)
	@$(TEST_BIN) org.junit.runner.JUnitCore $(TEST_CLASSES)

$(EXTRACT_TARGET): $(JODA_TIME_TESTS_SRC_JAR)
	@echo Extracting test sources from .jar.
	@unzip -q -o -d $(GEN_JAVA_DIR) $(JODA_CONVERT_TESTS_SRC_JAR) $(TEST_SOURCES)
...
$(TEST_BIN): $(OBJS)
	$(J2OBJCC) -ObjC -l junit -l guava -L $(BUILD_DIR) -l joda_convert -o $@ $<
