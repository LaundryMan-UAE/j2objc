...
TEST_BIN = $(BUILD_DIR)/joda_time_tests
...
TRANSLATE_ARGS = -cp $(DIST_LIB_DIR)/j2objc_joda_time.jar:$(DIST_LIB_DIR)/$(JUNIT_JAR) -q
...
$(EXTRACT_TARGET): $(JODA_TIME_TESTS_SRC_JAR)
	...
	@unzip -q -o -d $(GEN_JAVA_DIR) $(JODA_TIME_TESTS_SRC_JAR) $(TEST_SOURCES)
...
$(TEST_BIN): $(OBJS)
	$(J2OBJCC) -ObjC -l junit -l jsr305 -L $(BUILD_DIR) -l joda_time -o $@ $<
